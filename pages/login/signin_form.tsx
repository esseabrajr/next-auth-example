...
const signin = ({
  ...
  return (
    <form method="post" className="form" target="_self" autoComplete="off" action="/auth/callback/credentials">
      <div className="form-inner">
        ...
        <div className="input-wrapper">
          ...
          <div className="input-group"><span className="icon">
            ...
            <input type="password" name="password" id="login-password" data-lpignore="true"/>
          </div>
        </div>
        <div className="btn-group">
          <input type="submit" className="btn btn--primary" value="Entrar" /><a className="btn--text d-none" href="#0">Esqueceu a senha?</a>
        </div>
      </div>
    </form>
  )
